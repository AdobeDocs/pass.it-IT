...
**A:** Il monitoraggio della concorrenza non è in grado di distinguere direttamente tra contenuto live e video on-demand (VOD). Il lettore video deve conoscere il tipo di contenuto in riproduzione e inviare queste informazioni durante la [chiamata di inizializzazione della sessione](/help/concurrency-monitoring/api/cm-api-overview.md#session-initial) (richiesta per il monitoraggio della concorrenza). Il flusso di lavoro normale si presenta così:
...
* [Attributi metadati standard per il monitoraggio della concorrenza](/help/concurrency-monitoring/technical/standard-metadata-attributes.md)
* [Panoramica API di monitoraggio della concorrenza](/help/concurrency-monitoring/api/cm-api-overview.md)
