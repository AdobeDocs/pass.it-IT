...
*I dati di click-stream* rappresentano i dati condivisi dai clienti negli heartbeat della sessione (ad esempio, subjectID, mvpdName e metadati). Tutti i campi di metadati personalizzati sono indicati negli [attributi di metadati standard](/help/concurrency-monitoring/technical/standard-metadata-attributes.md).
