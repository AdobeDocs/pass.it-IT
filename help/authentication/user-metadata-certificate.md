...
1. Inviare il file PEM finale all&#39;Adobe per configurarlo.
   ...
   * Una volta che Adobe riceve il file PEM, i tecnici dell’autenticazione lo aggiungeranno alla configurazione sul lato server e confermeranno la ricezione del file.
