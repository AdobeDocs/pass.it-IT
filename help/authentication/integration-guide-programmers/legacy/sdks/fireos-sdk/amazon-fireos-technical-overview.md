...
1. Una volta selezionato un determinato MVPD, la pagina o il lettore deve informare AccessEnabler della scelta dell&#39;utente. Per i client non Flash, una volta selezionato il MVPD desiderato, si informa AccessEnabler della selezione dell&#39;utente tramite una chiamata al metodo [`setSelectedProvider()`](#setSelectedProvider). I client Flash inviano invece un `MVPDEvent` condiviso di tipo &quot;`mvpdSelection`&quot;, passando il provider selezionato.
