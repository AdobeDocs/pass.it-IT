...
Il campo `serializedToken` della chiamata &quot;Ottieni token file multimediali brevi&quot; è un token codificato Base64 che può essere verificato in base alla libreria di verifica di Adobe Media.
