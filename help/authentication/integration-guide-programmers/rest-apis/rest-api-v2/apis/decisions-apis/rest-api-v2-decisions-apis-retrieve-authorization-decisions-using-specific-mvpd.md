      ...
      <td>
         ...
         <table style="table-layout:auto">
            ...
            <tr>
               ...
               <td>
                  Informazioni sull’origine della decisione.<br/><br/>
                  I valori possibili sono:<ul>
                    <li><b>mvpd</b><br/>Decisione emessa dall'endpoint di autorizzazione MVPD.</li>
                    ...
                    <li><b>dummy</b><br/>Decisione emessa come risultato della funzionalità di autorizzazione fittizia.</li>
                  </ul>
               <td><i>obbligatorio</i></td>
            </tr>
            <tr>
               ...
               <td>
                  Informazioni sul token multimediale.<br/><br/>
                  Oggetto JSON con i seguenti attributi:<ul>
                    <li><b>notBefore</b><br/>La marca temporale in millisecondi prima della quale il token multimediale non è valido.</li>
                    <li><b>notAfter</b><br/>La marca temporale in millisecondi dopo la quale il token multimediale non è valido.</li>
                    <li><b>serializedToken</b><br/>Token multimediale con codifica Base64.</li>
                  </ul>
               <td>facoltativo</td>
            </tr>
            <tr>
               <td style="background-color: #DEEBFF;">notBefore</td>
               <td>La marca temporale in millisecondi prima della quale la decisione non è valida.</td>
               <td>facoltativo</td>
            </tr>
            <tr>
               <td style="background-color: #DEEBFF;">notAfter</td>
               <td>La marca temporale in millisecondi dopo la quale la decisione non è valida.</td>
               <td>facoltativo</td>
            </tr>
            <tr>
   ...
   <tr>
      ...
      <td>
            ...
            L’applicazione client deve implementare un meccanismo di gestione degli errori in grado di elaborare correttamente i codici di errore più comunemente restituiti da questa API:<ul>
                ...
                <li>authorized_rejected_by_mvpd</li>
...
### &#x200B;1. Recupera le decisioni di autorizzazione utilizzando mvpd specifico quando la decisione è consentita
...
### &#x200B;2. Recupera le decisioni di autorizzazione utilizzando mvpd specifico mentre la decisione è negata
...
### &#x200B;3. Recupera le decisioni di autorizzazione utilizzando mvpd specifico durante l’applicazione della degradazione
...
### &#x200B;4. Recuperare le decisioni di autorizzazione tramite TempPass di base
...
### &#x200B;5. Recupera le decisioni di autorizzazione tramite TempPass promozionale
