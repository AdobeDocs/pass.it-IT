...
Questo documento fornisce le definizioni dei termini utilizzati durante l&#39;integrazione della documentazione REST API V2 per l&#39;autenticazione di Adobe Pass e funge da sostituzione del nostro [Glossario](/help/authentication/kickstart/glossary.md) legacy.
...
Sinonimo del termine precedente utilizzato [ID richiedente](/help/authentication/kickstart/glossary.md#requestor-id).
