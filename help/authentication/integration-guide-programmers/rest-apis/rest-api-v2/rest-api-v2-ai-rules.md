...
Questo documento fornisce ai clienti di Adobe Pass Authentication regole strutturate e best practice progettate specificamente per lo sviluppo basato sull&#39;intelligenza artificiale di applicazioni TVE (TV Everywhere) che utilizzano [REST API V2](rest-api-v2-overview.md).

Seguendo le regole di sviluppo di IA descritte in questa guida, gli sviluppatori possono assicurarsi che i loro assistenti alla codifica di IA aiutino a creare integrazioni conformi, performanti e gestibili che rispettano i [requisiti obbligatori e le pratiche consigliate](rest-api-v2-checklist.md).

## Regole per assistenti di codifica {#coding-assistants-rules}

Le regole forniscono istruzioni a livello di sistema agli agenti. Considerali come contesto persistente, preferenze o flussi di lavoro. Le regole all&#39;interno di questo documento sono compatibili con gli assistenti di codifica basati sull&#39;intelligenza artificiale più diffusi e trasformano l&#39;[elenco di controllo V2 API REST](rest-api-v2-checklist.md) in linee guida per lo sviluppo dell&#39;intelligenza artificiale utilizzabili.

Inizia oggi stesso con la configurazione dell’ambiente di sviluppo di IA con il nostro set di regole completo e scopri i vantaggi della generazione di codice intelligente e conforme per l’integrazione di Adobe Pass Authentication REST API V2. Copia e incolla le regole di seguito nel file di configurazione dell’ambiente di sviluppo, a seconda dello strumento di intelligenza artificiale in uso.
...
- Retrieve configuration for specific service provider: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-configuration-apis/rest-api-v2-configuration-apis-retrieve-configuration-for-specific-service-provider
- Create authentication session: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-create-authentication-session
- Resume authentication session: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-resume-authentication-session
- Retrieve authentication session: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-retrieve-authentication-session-information-using-code
- Perform authentication in user agent: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-perform-authentication-in-user-agent
- Retrieve profiles: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profiles
- Retrieve profile for specific mvpd: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-mvpd
- Retrieve profile for specific code: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-code
- Retrieve authorization decisions using specific mvpd: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-authorization-decisions-using-specific-mvpd
- Retrieve preauthorization decisions using specific mvpd: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-preauthorization-decisions-using-specific-mvpd
- Initiate logout for specific mvpd: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-logout-apis/rest-api-v2-logout-apis-initiate-logout-for-specific-mvpd
- Retrieve partner authentication request: https://experienceleague.adobe.com/it/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-partner-authentication-request
