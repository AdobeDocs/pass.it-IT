...
>[!IMPORTANT]
>
>Per poter generare richieste di accesso a dati personali per l’autenticazione Adobe Pass, gli utenti devono essere autenticati. In caso contrario, i programmatori devono trovare altri mezzi per estrarre l’ID utente di MVPD.
...
La **documentazione API di Privacy Service** descrive in modo approfondito come un cliente Adobe può integrarsi con le API di Adobe.
