...
|-------------------------------|---------|---------|
| API REST v2 | &verifica; |         |
| API REST v1 | &verifica; | &verifica; |
| API di pre-autorizzazione SDK | &verifica; |         |
...
|-----------|-----------|---------------------------------------------------------------------------------------------------------------------|:----------:|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *azione* | *stringa* | *nessuno* | &verifica; | L’autenticazione di Adobe Pass ha consigliato un’azione che potrebbe risolvere la situazione come definito in questo documento. <br/><br/> Per ulteriori dettagli, consulta la sezione [Azione](#enhanced-error-codes-action). |
| *stato* | *numero intero* | *403* | &verifica; | Il codice di stato della risposta HTTP come definito nel documento [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6). <br/><br/> Per ulteriori dettagli, consulta la sezione [Stato](#enhanced-error-codes-status). |
| *codice* | *stringa* | *autorizzazione_negata_da_mvpd* | &verifica; | Il codice identificativo univoco dell’autenticazione Adobe Pass associato all’errore come definito in questo documento. <br/><br/> Per ulteriori dettagli, consulta la sezione [Codice](#enhanced-error-codes-code). |
...
|                    | *sessione di autenticazione_mancante* | 403, 412 | Impossibile recuperare la sessione di autenticazione associata a questa richiesta. Per continuare, l’utente deve autenticare di nuovo con un MVPD supportato. |
|                    | *sessione di autenticazione_scaduta* | 403, 412 | La sessione di autenticazione corrente è scaduta. Per continuare, l’utente deve autenticare di nuovo con un MVPD supportato. |
