...
- Rilasci di prodotti {#product-releases}
  - 2026 {#2026}
    - {hide-from-toc}[Note sulla versione di Adobe Pass Authentication 3.9.0](notes-releases/auth-rn-390.md)
    - [Note sulla versione di Adobe Pass Authentication 3.8.0](notes-releases/auth-rn-380.md)
    - [Note sulla versione di Adobe Pass Authentication 3.7.0](notes-releases/auth-rn-370.md)
    - [Note sulla versione di Adobe Pass Authentication 3.6.0](notes-releases/auth-rn-360.md)
  - 2025 {#2025}
    - [Note sulla versione di Adobe Pass Authentication Android 3.8.0](notes-releases/authn-rn-android-380.md)
    - [Note sulla versione di Adobe Pass Authentication 3.5.0](notes-releases/auth-rn-350.md)
...
- Guida All&#39;Integrazione Per Programmatori {#integration-guide-programmers}
  ...
  - Funzioni Premium {#features-premium}
    ...
    - Servizio SSO {#sso-service}
      - [Servizio Adobe Single Sign-On](integration-guide-programmers/features-premium/sso-service/sso-service.md)
    - Analytics {#analytics}
      ...
      - [Utilizzo dell’Experience Cloud ID nell’autenticazione di Adobe Pass](integration-guide-programmers/features-premium/analytics/exp-cloud-id-authn.md)
  - Legacy {#legacy}
...
- Guida utente per il dashboard di TVE {#user-guide-tve-dashboard}
  ...
  - [Dashboard ESM](/help/authentication/user-guide-tve-dashboard/tve-dashboard-esm.md)
