...
Android SDK v3.0+ utilizzerà la procedura di registrazione del client dinamico definita in [Registrazione client dinamico](/help/authentication/dynamic-client-registration.md).
