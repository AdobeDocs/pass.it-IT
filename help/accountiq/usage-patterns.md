...
Grafico a barre in *[!UICONTROL *Usage patterns distribution- Users in segment vs total]** mostra il numero e le percentuali di abbonati per ogni comportamento social o modello di utilizzo. Oltre a confrontare ogni modello di utilizzo nel segmento corrente con l’intero settore, li confronta anche con un segmento contenente tutti i canali.
...
Il **[!UICONTROL Usage pattern distribution]** La tabella fornisce un confronto tra la distribuzione del pattern di utilizzo per i canali del programmatore nel segmento corrente.
